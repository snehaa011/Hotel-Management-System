        ...
        <?php       
            if (isset($_POST['guestdetailsubmit'])) {
                ...
                if($Name == "" || $Email == "" ){
                    ...
                    $sta = "NotConfirm";
                    $sql = "INSERT INTO roombook(Name,Email,Phone,RoomType,NoofRoom,Meal,cin,cout,stat,nodays) VALUES ('$Name','$Email','$Phone','$RoomType','$NoofRoom','$Meal','$cin','$cout','$sta',datediff('$cout','$cin'))";
